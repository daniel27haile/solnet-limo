    ...
    children: [
      {
        ...
        loadComponent: () =>
          import("./features/admin/auth/login.component").then(
            (m) => m.LoginComponent,
          ),
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: "bookings",
            loadComponent: () =>
              import("./features/admin/bookings/bookings.component").then(
          ...
          },
          {
            path: "reviews",
            loadComponent: () =>
              import("./features/admin/reviews/reviews.component").then(
